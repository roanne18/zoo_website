...
$categories = [
    [
        ...
        'link' => 'categories_detail_care.php?category=Mammals'
    ],
    [
        'name' => 'Birds',
        'img'  => 'assets/bird.jpg',
        'link' => 'categories_detail_care.php?category=Birds'
    ],
    [
        'name' => 'Reptiles',
        'img'  => 'assets/reptiles.jpg',
        'link' => 'categories_detail_care.php?category=Reptiles'
    ],
    [
        'name' => 'Domesticated Animals',
        'img'  => 'assets/frog.jpg',
        'link' => 'categories_detail_care.php?category=Domesticated'
    ],
    [
        'name' => 'Aquatic',
        'img'  => 'assets/aquatic.jpg',
        'link' => 'categories_detail_care.php?category=Aquatic'
    ],
];
